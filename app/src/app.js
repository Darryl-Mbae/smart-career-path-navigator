...
import { Mail, Brain, CloudUpload, LogOut, Check, Goal, Route as Node, ChevronUp, ChevronLeft } from "lucide-react";
...
function Dashboard() {
  ...
  function DashSideBar() {
    return __jacJsx("div", {"className": "hidden md:flex md:w-64 bg-[#0b0b0b] h-screen flex-col border-r border-gray-800 fixed left-0 top-0"}, [__jacJsx("div", {"className": "p-6"}, [__jacJsx("div", {"className": "text-xl font-semibold text-white"}, ["Arise"])]), __jacJsx("nav", {"className": "flex-1 p-4 overflow-y-auto"}, [__jacJsx("div", {"className": "mb-6"}, [__jacJsx("div", {"className": "text-gray-500 text-xs uppercase font-semibold my-2 px-4 mb-4"}, ["Main"]), __jacJsx("ul", {"className": "list-none p-0 m-0 ml-[8px]"}, [__jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("dashboard");
    }, "className": baseLinkClasses + dashboardClasses}, [__jacJsx("span", {}, ["Dashboard"])])]), __jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("notifications");
    }, "className": baseLinkClasses + notificationsClasses}, [__jacJsx("span", {"className": "flex items-center justify-between w-full"}, [__jacJsx("span", {}, ["Notifications"]), unreadCount > 0 && __jacJsx("span", {"className": "ml-auto bg-primary text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center"}, [unreadCount])])])]), __jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("skills");
    }, "className": baseLinkClasses + skillsClasses}, [__jacJsx("span", {}, ["Skills"])])]), __jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("roles");
    }, "className": baseLinkClasses + rolesClasses}, [__jacJsx("span", {}, ["Roles"])])])])]), __jacJsx("div", {}, [__jacJsx("div", {"className": "text-gray-500 text-xs uppercase font-semibold m-y2 px-4 mb-4"}, ["Actions"]), __jacJsx("ul", {"className": "list-none p-0 m-0 ml-[8px]"}, [__jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("roadmap");
    }, "className": baseLinkClasses + roadmapClasses}, [__jacJsx("span", {}, ["My Roadmap"])])]), __jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("quizzes");
    }, "className": baseLinkClasses + quizzesClasses}, [__jacJsx("span", {}, ["Quizzes"])])])])])]), __jacJsx("div", {"className": "p-4 "}, [__jacJsx("div", {"className": "flex items-center gap-3 px-4 py-3 text-red-400"}, [__jacJsx(LogOut, {}, []), __jacJsx("div", {"className": "text-sm text-red-400 font-medium"}, ["Logout"])])])]);
  }
  function MobileDashSideBar() {
    ...
    return __jacJsx("div", {"className": baseClasses + " " + positionClass}, [__jacJsx("div", {"className": "p-6 border-b border-gray-800 flex items-center justify-between"}, [__jacJsx("div", {"className": "text-xl font-semibold text-white"}, ["Arise"]), __jacJsx("button", {"onClick": e => {
      ...
      setActiveLink("roles");
      setSidebarOpen(false);
    }, "className": baseLinkClasses + rolesClasses}, [__jacJsx("span", {}, ["Roles"])])])])]), __jacJsx("div", {}, [__jacJsx("div", {"className": "text-gray-500 text-xs uppercase font-semibold mb-2 px-4"}, ["Actions"]), __jacJsx("ul", {"className": "list-none p-0 m-0  ml-[8px]"}, [__jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("roadmap");
      setSidebarOpen(false);
    }, "className": baseLinkClasses + roadmapClasses}, [__jacJsx("span", {}, ["My Roadmap"])])]), __jacJsx("li", {"className": "mb-[2px]"}, [__jacJsx("div", {"onClick": e => {
      setActiveLink("quizzes");
      setSidebarOpen(false);
    }, "className": baseLinkClasses + quizzesClasses}, [__jacJsx("span", {}, ["Quizzes"])])])])])]), __jacJsx("div", {"className": "p-4 border-t border-gray-800"}, [__jacJsx("div", {"className": "flex items-center gap-3 px-4 py-3"}, [__jacJsx("div", {"className": "w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white font-semibold"}, ["U"]), __jacJsx("div", {"className": "flex-1"}, [__jacJsx("div", {"className": "text-white text-sm font-medium"}, ["User Name"]), __jacJsx("div", {"className": "text-gray-400 text-xs"}, ["user@email.com"])])])])]);
  }
  ...
  function DashContent() {
    return __jacJsx("div", {"className": "flex-1 p-6 md:p-8"}, [activeLink === "dashboard" && __jacJsx("div", {}, [__jacJsx("h1", {"className": "text-2xl md:text-3xl font-bold text-white mb-6"}, ["Welcome Back!"]), __jacJsx("div", {"className": "grid grid-cols-1 md:grid-cols-2 gap-4"}, [__jacJsx("div", {"className": "border border-gray-800 rounded-lg p-6"}, [__jacJsx("p", {}, ["Redirect to Udemy?"])]), __jacJsx("div", {"className": " border border-gray-800 rounded-lg p-6"}, [])])]), activeLink === "notifications" && __jacJsx("div", {}, [__jacJsx("div", {"className": "flex items-center justify-between mb-6"}, [__jacJsx("div", {}, [__jacJsx("h1", {"className": "text-2xl md:text-3xl font-bold text-white mb-2"}, ["Notifications"]), __jacJsx("p", {"className": "text-gray-400"}, ["You have ", unreadCount, " new notifications."])]), unreadCount > 0 && __jacJsx("button", {"onClick": e => {
    ...
    }, "className": "px-6 py-3 bg-[#101010ff] text-white rounded-lg hover:bg-[#1a1a1a] transition-all border border-gray-700 cursor-pointer font-semibold"}, ["Mark all as read"])]), __jacJsx("div", {"className": "bg-[#101010ff] border border-gray-800 rounded-lg overflow-hidden"}, [notifications.map(notification => {
      ...
      let bgClass = isUnread ? "bg-[#0b0b0b]" : "bg-transparent";
      return __jacJsx("div", {"key": notification.id, "className": bgClass + " border-b border-gray-800 last:border-b-0 p-6 hover:bg-[#0b0b0b] transition-all cursor-pointer", "onClick": e => {
        if (isUnread) {
          let updatedNotifications = notifications.map(n => {
