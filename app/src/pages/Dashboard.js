...
function Dashboard() {
  ...
  function ProfilePanel() {
    return __jacJsx("div", {"className": "hidden lg:block lg:w-80 bg-[#0b0b0b] h-screen border-l border-gray-800 p-6"}, [__jacJsx("div", {"className": "flex flex-col items-center mb-6"}, [__jacJsx("div", {"className": "w-20 h-20 rounded-full bg-primary flex items-center justify-center text-white font-semibold text-2xl mb-4"}, ["U"]), __jacJsx("div", {"className": "text-white font-medium"}, ["User Name"]), __jacJsx("div", {"className": "text-gray-400 text-sm"}, ["user@email.com"])]), __jacJsx("div", {}, [__jacJsx("h3", {"className": "mt-4 text-base font-normal text-gray-300 mb-6"}, ["Skills Insight"]), __jacJsx("div", {"className": "h-[27vh] w-full bg-[black] rounded-md"}, [])]), __jacJsx("div", {}, [__jacJsx("h3", {"className": "mt-4 text-base font-normal text-gray-300 mb-6"}, ["Recommendations"]), __jacJsx("div", {"className": "h-[27vh] w-full bg-[black] rounded-md"}, [])])]);
  }
