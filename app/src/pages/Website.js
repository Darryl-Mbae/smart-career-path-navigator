...
import { Mail, User, ChevronUp, Video, ChevronRight, Send, ChevronLeft, Github, Linkedin, AudioLines } from "lucide-react";
...
import phone from "@jac-client/assets/images/mobile-dash.png";
import desktop from "@jac-client/assets/images/laptop-dash.png";
...
function Website() {
  ...
  function NavBar(props) {
    let links = ["GITHUB", "FEATURES", "FAQs", "TEAM"];
    ...
    function DesktopNav() {
      return __jacJsx("div", {"className": "hidden md:flex  items-center justify-between text-white "}, [__jacJsx("a", {"href": "/app", "className": "text-[1.125rem] font-semibold cursor-pointer text-white no-underline"}, ["Arise"]), __jacJsx("div", {"className": "flex items-center gap-[2rem]"}, [__jacJsx("ul", {"className": "relative z-10 flex items-center gap-[10px] list-none"}, [links.map(link => {
        return __jacJsx("li", {"key": link, "className": "relative text-[14px] cursor-pointer px-2 py-1 rounded-[4px]", "onClick": e => {
          if (link === "GITHUB") {
            window.open("https://github.com/Darryl-Mbae/smart-career-path-navigator", "_blank");
          } else {
  ...
  function NewsletterSubscribe() {
    ...
    return __jacJsx("div", {"id": "CONTACT", "className": "w-11/12 mx-auto rounded-3xl text-white py-16 flex flex-col items-center justify-center shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] my-16"}, [__jacJsx(Mail, {"className": "w-10 h-10 mb-4 text-purple-300"}, []), __jacJsx("h2", {"className": "font-bold text-4xl text-center mb-7 w-3/5 font-sans"}, ["Stay Ahead of the Curve"]), __jacJsx("p", {"className": "text-base text-gray-100 text-center mb-8 max-w-3xl"}, ["Get exclusive insights, product updates, and early access delivered straight to your inbox."]), __jacJsx("form", {"className": "w-[90%] lg:w-1/2 flex flex-row gap-4 mx-auto"}, [__jacJsx("input", {"type": "email", "placeholder": "Enter your email", "value": email, "disabled": isSubmitting, "required": true, "onChange": e => {
  ...
  function Footer() {
    ...
    return __jacJsx("footer", {"className": "py-12 w-full bg-black"}, [__jacJsx("div", {"className": "max-w-7xl mx-auto px-8"}, [__jacJsx("div", {"className": "bg-[#0b0b0b] rounded-3xl p-12 shadow-md"}, [__jacJsx("div", {"className": "grid grid-cols-1 lg:grid-cols-5 gap-8 border-b border-gray-800 pb-10"}, [__jacJsx("div", {"className": "col-span-2 flex flex-col gap-6"}, [__jacJsx("div", {"className": "flex items-center gap-2"}, [__jacJsx("span", {"className": "text-white font-bold text-xl"}, ["Arise"])]), __jacJsx("p", {"className": "text-gray-400 max-w-xs leading-relaxed"}, ["Arise is an AI-powered career mapping platform that analyzes your skills, identifies career opportunities, and creates personalized learning roadmaps to help you achieve your professional goals."]), __jacJsx("div", {"className": "flex gap-4 pt-2"}, [socialLinks.map(social => {
    ...
    })])]), __jacJsx("div", {"className": "hidden col-span-3 lg:grid grid-cols-4 gap-6"}, [footerSections.map(section => {
      return __jacJsx("div", {"key": section.title, "className": "flex flex-col gap-2"}, [__jacJsx("h3", {"className": "text-white font-semibold text-sm"}, [section.title]), section.links.map(link => {
        return __jacJsx("a", {"key": link.label, "href": link.href, "className": "text-gray-400 text-sm hover:text-white cursor-pointer", "onClick": e => {
          ...
          e.preventDefault();
          let sectionEl = document.getElementById(link.href);
      ...
      return __jacJsx("a", {"key": link.href, "href": link.href, "target": "_blank", "rel": "noopener noreferrer", "className": "text-gray-500 hover:text-white whitespace-nowrap"}, [link.label]);
    })])])])])]);
  }
