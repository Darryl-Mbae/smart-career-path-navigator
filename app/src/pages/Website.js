...
import { Mail, User, ChevronUp, ChevronRight, ChevronLeft, Github, Linkedin } from "lucide-react";
...
function Website() {
  ...
  function Team() {
    ...
    let teamMembers = [{id: 1, name: "Darryl Mbae", image: Darryl}, {id: 2, name: "Kiptanui Denis", image: Dennis}, {id: 3, name: "Mohammed", image: Moha}, {id: 4, name: "Darryl Mbae", image: Darryl}, {id: 5, name: "Kiptanui Denis", image: Dennis}, {id: 6, name: "Mohammed", image: Moha}];
    return __jacJsx("div", {"className": "w-[80%] mx-auto py-20 grid grid-cols-1 lg:grid-cols-[40%_60%] gap-10 items-center"}, [__jacJsx("div", {}, [__jacJsx(User, {"className": "w-10 h-10 mb-4 text-purple-300"}, []), __jacJsx("h2", {"className": "font-bold text-4xl text-white mb-7 w-full font-sans"}, ["Built by Students,", __jacJsx("br", {}, []), " For Students"]), __jacJsx("p", {"className": "text-base text-gray-100  mb-8 w-[95%]"}, [paragraph])]), __jacJsx("div", {"className": "relative"}, [__jacJsx("div", {"className": "absolute left-0 bottom-0 w-full lg:w-[calc(33.333%-10px)] z-20 pointer-events-none"}, [__jacJsx("div", {"className": "w-full bg-primary backdrop-blur-sm rounded-xl px-5 py-3 border border-gray-700/50 shadow-xl"}, [__jacJsx("h3", {"className": "text-white font-bold text-lg mb-3"}, [teamMembers[activeSlide].name]), __jacJsx("div", {"className": "flex gap-2"}, [__jacJsx("button", {"className": "w-8 h-8 rounded-full border border-white cursor-pointer flex items-center justify-center transition-colors pointer-events-auto"}, [__jacJsx("span", {"className": "text-white text-xs flex items-center justify-center"}, [__jacJsx(Linkedin, {"className": "h-3 w-3 m-auto"}, [])])]), __jacJsx("button", {"className": "w-8 h-8 rounded-full border border-white cursor-pointer flex items-center justify-center transition-colors pointer-events-auto"}, [__jacJsx("span", {"className": "text-white text-xs flex items-center justify-center"}, [__jacJsx(Github, {"className": "h-3 w-3 m-auto"}, [])])]), __jacJsx("button", {"className": "w-8 h-8 rounded-full border border-white cursor-pointer flex items-center justify-center transition-colors pointer-events-auto"}, [__jacJsx("span", {"className": "text-white text-xs flex items-center justify-center"}, [__jacJsx(Mail, {"className": "h-3 w-3 m-auto"}, [])])])])])]), __jacJsx(Swiper, {"initialSlide": startIndex, "onSwiper": swiper => {
